...
import AdminOperationsStaffPage from "./pages/AdminOperationsStaffPage"
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/admin/staff" element={<ProtectedRoute allowedPermission="staff.manage"><AdminStaffPage /></ProtectedRoute>} />
        <Route path="/admin/schedules" element={<ProtectedRoute allowedRoles={["admin", "clinical_head"]}><AdminSchedulesPage /></ProtectedRoute>} />
        ...
        <Route path="/admin/schedule/:id" element={<ProtectedRoute allowedRoles={["admin", "clinical_head"]}><AdminScheduleDetailsPage /></ProtectedRoute>} />
        <Route path="/admin/schedule/edit/:id" element={<ProtectedRoute allowedRoles={["admin", "clinical_head"]}><AdminEditSchedulePage /></ProtectedRoute>} />
        ...
        <Route path="/admin/schedule/missed" element={<ProtectedRoute allowedRoles={["admin", "clinical_head"]}><AdminMissedSchedulesPage /></ProtectedRoute>} />
