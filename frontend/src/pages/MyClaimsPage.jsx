  ...
  return (
    <TherapistLayout>
      <div className="w-full max-w-7xl mx-auto">
        ...
        {/* Title scales naturally down to 2xl on smaller screens */}
            ...
            claims.map((claim) => (
              ...
              >
                ...
                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <div>
                    <span className="text-xs text-gray-400 block font-medium">Claim Date</span>
                    <span className="font-semibold text-gray-800">{claim.claim_date}</span>
                  </div>
                ...
                {/* Full width touch-friendly interactive button */}
                <div className="pt-2">
                  <button
                    onClick={() => navigate(`/therapist/claim/${claim.id}`)}
        ...
        {/* ==================== 2. DESKTOP WIDESCREEN TABLE VIEW ==================== */}
              ...
              <tbody className="divide-y divide-gray-100">
                {claims.map((claim) => (
                  <tr key={claim.id} className="hover:bg-gray-50 transition-colors">
                    <td className="p-4 text-sm text-gray-800">{claim.claim_date}</td>
